...
#' \item Stand-alone tools to convert or resample MP3, WAV, and WAC files.
#' \item Read, display, MP3, WAV or WAC files, filter, and extract automatically acoustic features.
#' }
#'
