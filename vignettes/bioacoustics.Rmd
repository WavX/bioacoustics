...
This package is subdivided into three main components containing R functions acccessible to users and internal functions that will also be defined bellow for the sake of clarity. The three main components with the current functions are as follow:
